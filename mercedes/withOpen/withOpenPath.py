...
file_path = os.path.join(script_dir, "textoPath.txt") #ej: "/home/mauri/uni/UTN/withOpen/texto.txt"
...
with open(file_path, "w") as file:
    ...
    # Escribimos otra línea con salto de línea
    file.write("esto es otra linea\n")

    # Otra línea, aclarando que no usamos salto entre las instrucciones, pero sí dentro del texto
    file.write("como vieron, entre cada file.write no use el salto de linea\n")
